...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <section id="intro" class="intro">
		...
		<div class="slogan">
			<h2>BEM VINDO AO <span class="text_color"><font color='red'>PHOTOGRAPHY</font></span> </h2>
			<h4><font color='#67b0d1'>ETERNIZE SEU MOMENTO!</font></h4>
		</div>
    ...
    <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select id="subject" name="subject" class="form-control" required="required">
                                ...
                                <option value="service">Sobre meu pedido</option>
		...
		<div class="col-lg-4">
			<div class="widget-contact">
				...
				<address>
				  <strong>Web designers mother fuck</strong><br>
				  Por ali mesmo<br>
				  Cco, UFFS<br>
				  <abbr title="Telefone">P:</abbr> 0000000
				</address>
				...
				<address>
				  <strong>Estamos nas redes sociais</strong><br>
                       	<ul class="company-social">
                            <li class="social-facebook"><a href="https://facebook.com/" target="_blank"><i class="fa fa-facebook"></i></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12">
					...
					<p><font color='red'><h4>PHOTOGRAPHY</h4></font></p>
				</div>
			</div>	
		</div>
	</footer>
